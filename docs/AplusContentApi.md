...
> PostContentDocumentResponse createContentDocument(body, marketplaceId)
...
> PostContentDocumentAsinRelationsResponse postContentDocumentAsinRelations(body, marketplaceId, contentReferenceKey)
...
String contentReferenceKey = "contentReferenceKey_example"; // String | The unique reference key for the A+ Content document. A content reference key cannot form a permalink and may change in the future. A content reference key is not guaranteed to match any A+ content identifier.
try {
    PostContentDocumentAsinRelationsResponse result = apiInstance.postContentDocumentAsinRelations(body, marketplaceId, contentReferenceKey);
    System.out.println(result);
} catch (ApiException e) {
...
> PostContentDocumentResponse updateContentDocument(body, marketplaceId, contentReferenceKey)
...
String contentReferenceKey = "contentReferenceKey_example"; // String | The unique reference key for the A+ Content document. A content reference key cannot form a permalink and may change in the future. A content reference key is not guaranteed to match any A+ Content identifier.
try {
    PostContentDocumentResponse result = apiInstance.updateContentDocument(body, marketplaceId, contentReferenceKey);
    System.out.println(result);
} catch (ApiException e) {
...
> ValidateContentDocumentAsinRelationsResponse validateContentDocumentAsinRelations(body, marketplaceId, asinSet)
